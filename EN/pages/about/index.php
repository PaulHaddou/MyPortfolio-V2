                    ...
                    <div class="skills_infos">
                        ...
                        <div class="infos_details">
                            <div class="details_dev">
                                <p class="dev_title"><?= $about_Skills_Development_Title ?></p>
                                <p class="dev_technos"><?= $about_Skills_Development_Languages ?></p>
                                <p class="dev_softwares"><?= $about_Skills_Development_Softwares ?></p>                               
                            </div>
