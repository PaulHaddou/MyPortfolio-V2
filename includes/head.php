...
<head>
    ...
    <link rel="stylesheet" href="<?= $path_Files_Head ?>styles/navbar/navbar.min.css">
    <link rel="stylesheet" href="<?= $path_Files_Head ?>styles/<?= $path_Page_CSS ?>/<?= $path_Page_CSS ?>.min.css">
